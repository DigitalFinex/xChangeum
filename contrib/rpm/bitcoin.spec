...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 5679
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 5680
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 15679
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 15682
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 5679
	%{_sbindir}/semanage port -d -p tcp 5680
	%{_sbindir}/semanage port -d -p tcp 15679
	%{_sbindir}/semanage port -d -p tcp 15682
