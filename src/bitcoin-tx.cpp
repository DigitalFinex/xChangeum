...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s xchangeum-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  xchangeum-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xchangeum transaction") + "\n" +
              "  xchangeum-tx [options] -create [commands]   " + _("Create hex-encoded xchangeum transaction") + "\n" +
              "\n";
